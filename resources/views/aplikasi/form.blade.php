					...
					<form name="input-penerima" method="POST" action="{{url('receptions')}}">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="custom-file col-sm-12 col-md-10">
								<input type="file" class="custom-file-input" name="ft" />
                        ...
                        <div class="form-group row">
                            ...
                            <div class="custom-file col-sm-12 col-md-10">
								<input type="file" class="custom-file-input" name="ft_ktp" />
								<label class="custom-file-label">Pilih Gambar</label>
							</div>
                        </div>
                        <div class="form-group row">
                            ...
                            <div class="custom-file col-sm-12 col-md-10">
								<input type="file" class="custom-file-input" name="ft_kk"/>
								<label class="custom-file-label">Pilih Gambar</label>
							</div>
                        </div>
                        <div class="form-group row">
                            ...
                            <div class="custom-file col-sm-12 col-md-10">
								<input type="file" class="custom-file-input" name="ft_rmh"/>
								<label class="custom-file-label">Pilih Gambar</label>
							</div>
                        </div>
                        <div class="form-group row">
